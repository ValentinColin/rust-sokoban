...
/// Game struct that describe the game world
struct Game {
    world: World,
}
...
pub fn main() -> GameResult {
    ...
    let context_builder = ggez::ContextBuilder::new("rust_sokoban", "sokoban")
        .window_setup(conf::WindowSetup::default().title("Rust Sokoban!").icon("/images/player_1.png"))
        .window_mode(conf::WindowMode::default().dimensions(600.0, 288.0))
